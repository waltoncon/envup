...
export type StartRuleNames = "TfVars";
export interface ParseOptions<T extends StartRuleNames = "TfVars"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"TfVars">>(
  input: string,
  options?: Options,
): string;
